...
results_dir = os.path.join(os.path.dirname(__file__), "../../data/raw/preservation_catalog/20191203")
df = pd.read_csv('../../data/raw/preservation_catalog/20191202/Project.csv')
updated_col_names = {}
